...
- **Community Gift:** Pro and Admin users can generate documents for any public idea. These docs become a community gift, properly crediting the contributors who used their premium access to help out.
...
- Filter by visibility (Public/Private) and duration (1 week to 2 months)
- Sort by newest or oldest
- Pagination for smoothly browsing thousands of entries
- Related ideas on detail pages

### Personal & Admin Dashboard

- **Role-based views:** Users see their own personal analytics, while Admins get a comprehensive overview of the entire platform.
- **Admin Powers:** Admins can view and manage all users' data (both private and public), generate unlimited ideas/blogs, and generate documents for any user's idea as a Community Gift.
