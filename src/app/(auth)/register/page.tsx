      ...
      <FadeIn className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 font-bold text-xl mb-6">
            <div className="flex size-10 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-primary/70 text-primary-foreground text-base font-black shadow-sm">
              ID
            </div>
            IdeaDen
          </Link>
          ...
          <p className="text-muted-foreground mt-2">
            Start building project project ideas with AI
          </p>
        </div>
          ...
          <form action={submitAction} className="flex flex-col gap-4" noValidate>
            ...
            <div className="flex flex-col gap-2">
              ...
              {imageMode === "url" ? (
                ...
                <div className="flex flex-col gap-2">
                  <label className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-lg border border-dashed px-3 py-2.5 text-sm font-medium text-muted-foreground transition-colors hover:border-foreground/30 hover:bg-muted/10 hover:text-foreground">
                    <ImageIcon size={16} />
              ...
              {preview && (
                <div className="relative mt-1 aspect-square w-16 overflow-hidden rounded-full border shadow-sm mx-auto">
                  <Image
                    src={preview}
                    alt="Preview"
                    fill
            ...
            <Button type="submit" disabled={submitting || !passwordValid} className="w-full font-semibold mt-1">
            ...
            <Button type="button" variant="outline" onClick={handleGoogle} className="w-full font-semibold">
