...
export default function IdeaDetailPage({
  ...
  const contributors = docs?.contributors || (docs?.generatedBy && docs?.generatedById !== idea.ownerId ? [docs.generatedBy] : []);
  const isCourtesy = contributors.length > 0;
        ...
        <div className="w-full">
          {isCourtesy && (
            <SlideUp delay={0.05}>
              <div className="mb-4 flex items-center gap-2 rounded-lg border border-amber-500/30 bg-amber-500/10 px-4 py-3 text-sm text-amber-800 dark:text-amber-300">
                ...
                <p>
                  <strong className="font-semibold text-amber-900 dark:text-amber-100">Community Gift: </strong> Premium docs generated by <span className="font-semibold">{contributors.join(", ")}</span>.
                </p>
              </div>
            </SlideUp>
          )}
          ...
          <SlideUp delay={0.1}>
            <Card className="border bg-card shadow-sm">
              ...
              <CardContent className="p-10 sm:p-14 flex flex-col items-center justify-center text-center">
                ...
                <p className="text-sm text-muted-foreground max-w-md">
                  Project docs are a{" "}
                  <span className="font-medium text-foreground">Pro feature</span>{" "}
                  generated by the idea owner. The owner of this blueprint has
                  not generated this document yet, so there is nothing to show
                  here right now.
                </p>
                <div className="mt-6 flex items-center gap-2 rounded-full border bg-muted/50 px-4 py-2 text-xs text-muted-foreground">
                  <Lock className="size-3.5 text-amber-500" />
                  Generated from the owner Pro workspace
                </div>
              </CardContent>
            </Card>
          </SlideUp>
